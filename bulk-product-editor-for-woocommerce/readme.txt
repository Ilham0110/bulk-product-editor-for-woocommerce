...
* Fixed: a damaged entry in your saved views could break the Views feature entirely, with deleting a view failing on a server error — and deleting was the only way to remove the damaged entry. Bad entries are now skipped instead.
